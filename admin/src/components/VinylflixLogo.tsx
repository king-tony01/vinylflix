...
export const VinylflixLogo: React.FC<VinylflixLogoProps> = ({ className = 'w-8 h-8', size }) => {
  return (
    <svg
      ...
      className={`inline-block flex-shrink-0 max-w-full max-h-full ${className}`}
    >
      <path
      ...
      <path
        ...
        fill="url(#admin_vf_linear_2)"
      />
      <defs>
        <linearGradient id="admin_vf_linear_0" x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
        <linearGradient id="admin_vf_linear_1" x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
        <linearGradient id="admin_vf_linear_2" x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
      </defs>
