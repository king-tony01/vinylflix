...
export const VinylflixLogo: React.FC<VinylflixLogoProps> = ({ className = 'w-8 h-8', size }) => {
  ...
  const g0 = `admin_vf_linear_0_${id}`;
  const g1 = `admin_vf_linear_1_${id}`;
  const g2 = `admin_vf_linear_2_${id}`;
  ...
  return (
    <svg
      ...
      className={`inline-block shrink-0 flex-shrink-0 max-w-full max-h-full ${className}`}
    >
      <defs>
        <linearGradient id={g0} x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
        <linearGradient id={g1} x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
        <linearGradient id={g2} x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
      </defs>
