  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill="url(#vf_linear_2)"
      />
      <defs>
        <linearGradient id="vf_linear_0" x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
        <linearGradient id="vf_linear_1" x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
        <linearGradient id="vf_linear_2" x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
      </defs>
