  ...
  return (
    ...
    >
      <path
        ...
        fill="url(#next_vinylflix_linear_0)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="url(#next_vinylflix_linear_1)"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        fill="url(#next_vinylflix_linear_2)"
      />
      <defs>
        <linearGradient id="next_vinylflix_linear_0" x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
        <linearGradient id="next_vinylflix_linear_1" x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
        <linearGradient id="next_vinylflix_linear_2" x1="28.5" y1="0" x2="28.5" y2="55" gradientUnits="userSpaceOnUse">
          <stop stopColor="#FF0091" />
          <stop offset="1" stopColor="#360099" />
        </linearGradient>
      </defs>
