      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs">
              <li>
                <a href="https://vinylflix.onrender.com/" className="hover:text-white transition-colors">
                  Watch & Earn Feed
                </a>
              </li>
              <li>
                <a href="https://vinylflix.onrender.com/memberships" className="hover:text-white transition-colors">
                  Membership Plans
                </a>
              </li>
              <li>
                <a href="https://vinylflix.onrender.com/referrals" className="hover:text-white transition-colors">
                  Refer & Earn Network
                </a>
              </li>
              <li>
                <a href="https://vinylflix.onrender.com/campaigns" className="hover:text-white transition-colors">
                  Creator Campaign Hub
                </a>
              </li>
              <li>
                <a href="https://vinylflix.onrender.com/wallet" className="hover:text-white transition-colors">
        ...
        <div className="mt-12 pt-8 border-t border-[#2a0054]/50 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div className="flex items-center gap-6">
            ...
            <a href="https://vinylflix.onrender.com" className="hover:text-slate-300">Launch App</a>
          </div>
        </div>
      </div>
    </footer>
