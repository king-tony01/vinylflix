    ...
    <div className="space-y-24 md:space-y-32 overflow-hidden">
      ...
      <section className="relative pt-12 md:pt-20 pb-16 md:pb-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-4xl mx-auto space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#1e003b] border border-[#FF0091]/30 text-xs font-bold text-pink-300 shadow-lg shadow-[#FF0091]/10 animate-bounce-subtle">
            <Sparkles className="w-3.5 h-3.5 text-[#FF0091]" />
            <span>The Premier Attention & Rewarded Video Network</span>
          </div>
